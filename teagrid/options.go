...
// WithCellCursorMode enables or disables cell cursor mode.
// When enabled, left/right arrow keys navigate between cells instead of pages.
// Default is false (original pagination behavior).
