module github.com/mikeschinkel/go-tealeaves/examples/teadepview/treenav

go 1.25.3

require (
	github.com/mikeschinkel/go-tealeaves/teadepview v0.0.0
...
replace github.com/mikeschinkel/go-tealeaves/teadepview => ../../../teadepview
