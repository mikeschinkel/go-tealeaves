...
- `ElectricCyan color.Color = Color("#67e8f9")`
...
- `Gunmetal color.Color = Color("#1f2937")`
- `HotPink color.Color = Color("#FF69B4")`
- `IceCyan color.Color = Color("#a5f3fc")`
...
- `Layout struct{}`
  - Methods
    - `Height() int`
    - `MarkDirty()`
    - `Pane(name string) *Pane`
    - `Render() (string, error)`
    - `Root() *Pane`
    - `SetSize(width int, height int)`
    - `Width() int`

- `MultiPaneLayout struct{}`
  - Methods
    - `EnsureFocusedVisible()`
    - `FocusNext()`
    - `FocusPane(name string) error`
    ...
    - `Focused(name string) bool`
    - `FocusedPane() *Pane`
    - `HidePane(name string)`
    - `MarkDirty()`
    - `Pane(name string) *Pane`
    - `PaneLayout() *PaneLayout`
    - `PaneNames() []string`
    - `Render() (string, error)`
    - `ResizeFocused(delta float64)`
    - `SetPaneVisible(name string, visible bool)`
    - `SetSize(w int, h int)`
    - `ShowAllPanes()`
    - `ShowPane(name string)`
    - `SoloPane(name string)`
    - `TogglePane(name string)`
    - `VisibleFlexPercent(name string) float64`
    - `VisibleFlexPercents() map[string]float64`
    - `VisiblePaneNames() []string`

- `MultiPaneLayoutOption func(*multiPaneConfig)`
...
- `Pane struct{}`
  - Methods
    ...
    - `View() string`
    - `Visible() bool`
    - `WithAlignment(a Alignment) *Pane`
    - `WithFocusable() *Pane`
    - `WithGap(n int) *Pane`
    - `WithMaxSize(n int) *Pane`
    - `WithMinFlexWeight(w float64) *Pane`
    - `WithMinSize(n int) *Pane`
    - `WithMinSizeFit() *Pane`
    - `WithName(name string) *Pane`
    - `WithOptional(b bool) *Pane`
    - `WithoutFocusable() *Pane`
    - `WithoutMinSizeFit() *Pane`
...
- `StackLayoutModel struct{}`
  - Methods
    - `CanPop() bool`
    - `Current() StackView`
    - `DeleteCached(key string)`
    - `Depth() int`
    - `GetCached(key string) (StackView, bool)`
    - `Init() tea.Cmd`
    - `Pop() (tea.Cmd, error)`
    - `PopTo(depth int) (tea.Cmd, error)`
    - `Push(view StackView, cacheKey string) tea.Cmd`
    - `Update(msg tea.Msg) (tea.Model, tea.Cmd)`
    - `UpdateCurrent(updated StackView)`
    - `View() tea.View`
...
- `BorderStyle struct{}`
  - Properties
    ...
    - `PaddingV int`
  - Methods
    - `Build(focused bool) lipgloss.Style`
    - `FrameHeight() int`
    - `FrameWidth() int`

- `ContentFunc func(width, height int, focused bool) string`
...
- `PlainPane struct{}`
  - Methods
    ...
    - `View() string`
    - `Width() int`
    - `WithStyle(s lipgloss.Style) *PlainPane`

- `ScrollContentFunc func(width, height, offset int) string`
...
- `StyledPane struct{}`
  - Methods
    ...
    - `Height() int`
    - `Label() string`
    - `SetContentFunc(fn ContentFunc)`
    - `SetFlexPercent(pct float64)`
    - `SetSize(w int, h int)`
    - `SizeHint(_ int, _ int) tealayout.SizeHint`
    - `Style() lipgloss.Style`
    - `View() string`
    - `Width() int`
    - `WithLabel(label string) *StyledPane`
    - `WithMinWidth(n int) *StyledPane`
...
- `NewSemanticColor = teacolor.NewSemanticColor`
...
- `Stderrf(format string, args ...any)`
...
- `SemanticColor = teacolor.SemanticColor`
