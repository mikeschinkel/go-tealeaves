...
modules := "teadiffr teafields teadepview teagrid teamodal teanotify teastatus teatext teatree teautils"

# Example modules (each is an independent Go module)
examples := "examples/teafields/simple examples/teafields/demo examples/teadepview/treenav examples/teamodal/choices examples/teamodal/editlist examples/teamodal/various examples/teanotify/simple examples/teastatus/statusbar examples/teatext/editor examples/teatree/filetree examples/teagrid/simplest examples/teagrid/sorting examples/teagrid/filtering examples/teagrid/scrolling examples/teautils/keyhelp"
