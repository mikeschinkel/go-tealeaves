...
examples := "examples/teadd/simple examples/teadd/demo examples/teadep/treenav examples/teamodal/choices examples/teamodal/editlist examples/teamodal/various examples/teanotify/simple examples/teastatus/statusbar examples/teatextsel/editor examples/teatree/filetree examples/teagrid/simplest examples/teagrid/sorting examples/teagrid/filtering examples/teagrid/scrolling examples/teautils/keyhelp"
