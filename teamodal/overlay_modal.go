...
// This follows the proven pattern from teafields (same as OverlayDropdown).
//
// Parameters:
...
// This follows the pattern from teafields: split into left + overlay + right.
//
...
func overlayLine(background, foreground string, col int) string {
	...
	// This is the same pattern as teafields's overlayLine()
	var result strings.Builder
