module github.com/mikeschinkel/go-tealeaves/temp
...
replace (
	...
	github.com/mikeschinkel/go-tealeaves/teamodal => ../../../go-tealeaves/teamodal
	github.com/mikeschinkel/go-tealeaves/teautils => ../../../go-tealeaves/teautils
)
